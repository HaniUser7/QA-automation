...
public class VerifyCreateAlbum_PendingEmailUserPermessions_Profilepage extends
	...
	// Disable Create Album settings from back end and verify Album on Profile page for pending Email Users
	...
	// Enable Create Album Permissions from back end and verify create new album Through add Album on profile page for PendinEmail  Users &  Verify Added Image On Albums
	...
	// Enable Delete Own image Permissions from back end and verify Delete album Through  In Album on  profile page for PendinEmail  Users &  Verify Delete Image On Albums
		
	 @Test(priority = 2)
	public void VerifyEnableDeleteOwnImagesettingsfrombackend_verifyDeleteAlbumonProfilePageforpendingEmailUSers()
			throws InterruptedException, IOException, AWTException {
		AccountSettingsPageObjects Album = new AccountSettingsPageObjects();
		UsersGroupPermissionspageObject AlbumPermessions = new UsersGroupPermissionspageObject();
		// Account user permission by checking Album for Pending Email User
		...
		AlbumPermessions.Managelinks_PendingEmail,
		AlbumPermessions.ChangePermission_PendingEmail,
		AlbumPermessions.DeleteOwnImages_checkbox, true);
